...
public class Test {
	...
	public static void main(String[] args) {
		...
		e1[1] = new Example();
		e3[1] = new Example();
		System.out.println(e1[1].x);//10
		//System.out.println(e2[1].x);//CE
		System.out.println(e3[1].x);//10
		
		Test t = new Test();
		System.out.println(t.e2[1].x);
		
		//System.out.println(e1[0].x);//NPE
		System.out.println(t.e2[0].x);//NPE
		//System.out.println(e3[0].x);
		//System.out.println(t.e1[1].y);//CE
	}
